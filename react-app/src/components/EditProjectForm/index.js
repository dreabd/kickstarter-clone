...
import { stateNames, stateAbb } from "../ProjectForm/stateNames";
...
const EditProjectForm = () => {
  ...
  const [endDate, setEndDate] = useState(
    formatDate(project?.end_date) || "2024-01-01"
  );
  ...
  console.log(
    "This is the state variable category is defaulted to..................",
    category
  );
  ...
  useEffect(() => {
    if (!project) {
      ...
      console.log(
        "This is how it is coming back from the database.......",
        project.category
      );
  ...
  const handleSubmit = async (e) => {
    ...
    const editedProjectOrErrors = await dispatch(
      editProjectThunk(project.id, formData)
    );
      ...
      >
        ...
        <label>
          ...
          <select
            ...
            onChange={(e) => {
              console.log(
                "This is e.target.value in the on change.................",
                e.target.value
              );
        ...
        <label>
          ...
          <div>
            <p>
              <a href={projectImage}>Existing Project Image</a>
            </p>
